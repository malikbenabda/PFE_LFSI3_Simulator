...
public class Liste_Defauts_definition_encadrant extends JFrame implements
	...
	public Liste_Defauts_definition_encadrant() {
		...
		lblpo.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
		...
		lblbth.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblmrc.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblpl.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblpn.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblrtr.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblgch.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblrl.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lbltd.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblov.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblrce.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblpm.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblst.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblcc.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblstb.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblfte.setIcon(new ImageIcon(Liste_Defauts_definition_encadrant.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		btnAcceuil.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				Start_Encadrant fr = new Start_Encadrant();
				fr.setVisible(true);
				dispose();
			}
		});
	...
	public void mouseClicked(MouseEvent arg0) {
		...
		// au click sur nom de defaut une page de definition de ce defaut
		// s'affiche pour permettre l'encadrant de lire et modifier le contenue
		// de definition
	}
	...
	public void mouseMoved(MouseEvent arg0) {
		// si le mouvement de curseur est detecté sur le label de nom de defaut
		// , l'image de celuici sera affiché a gauche dans la zone d'aperçu
		if (arg0.getSource() == lblpo)
	...
	private void create_defaut_definition_frame(String title, String code) {
		// creation de frame definition de mode encadrant et passage de titre de
		// frame avec le code de defaut comme parametres

		Definition_defaut_encadrant a = new Definition_defaut_encadrant(title,
				code);
		a.setVisible(true);
		a.seteditable(true);
		dispose();
