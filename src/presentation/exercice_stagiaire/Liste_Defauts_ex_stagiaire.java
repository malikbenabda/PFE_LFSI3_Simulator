...
public class Liste_Defauts_ex_stagiaire extends JFrame implements
	...
	public Liste_Defauts_ex_stagiaire() {
		...
		lblpo.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
		...
		lblbth.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblmrc.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblpl.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblpn.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblrtr.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblgch.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblrl.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lbltd.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblov.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblrce.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblpm.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblst.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblcc.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblstb.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
		...
		lblfte.setIcon(new ImageIcon(Liste_Defauts_ex_stagiaire.class
				.getResource("/com/jtattoo/plaf/icons/pearl_blue_28x28.png")));
	...
	public void mouseClicked(MouseEvent arg0) {
		...
		if (arg0.getSource() == lblpo)
			create_simulation("Peau D'Orange", "po");

		if (arg0.getSource() == lblbth)
			create_simulation("BULLES OU TRACES D'HUMIDITE ",
					"bth");
		...
		if (arg0.getSource() == lblpl)
			create_simulation("PLISSEMENT LONGITUDINAL ", "pl");

		if (arg0.getSource() == lblpn)
			create_simulation("POINTS NOIRS ", "pn");

		if (arg0.getSource() == lblrtr)
			create_simulation("RETRAIT", "rtr");

		if (arg0.getSource() == lblgch)
			create_simulation("GAUCHISSEMENT", "gch");

		if (arg0.getSource() == lblrl)
			create_simulation("RAYURES LONGITUDINALES ", "rl");

		if (arg0.getSource() == lbltd)
			create_simulation("TRAINEES DE DEGRADATION", "td");

		if (arg0.getSource() == lblov)
			create_simulation("OVALISATION", "ov");
		...
		if (arg0.getSource() == lblpm)
			create_simulation("POLLUTION MATIERE", "pm");

		if (arg0.getSource() == lblst)
			create_simulation("SURFACE TERNE ", "st");

		if (arg0.getSource() == lblcc)
			create_simulation("CHANGEMENT DE COULEUR ", "cc");

		if (arg0.getSource() == lblstb)
			create_simulation("SURFACE TROP BRILLANTE ", "stb");

		if (arg0.getSource() == lblfte)
			create_simulation("FOSSETTES OU TRACES D'EAU ", "fte");
		arg0.getComponent().setForeground(new Color(128, 0, 128));
	...
	private void create_simulation(String title, String code) {
		Acceuil_machine_defaut a = new Acceuil_machine_defaut(code);
		a.setTitle("Defaut present : " + title);
		a.setVisible(true);
		dispose();
	}
