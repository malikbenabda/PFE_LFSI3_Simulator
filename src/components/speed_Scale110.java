...
public class speed_Scale110 extends JPanel {
	 ...
	 * Create the panel.
	 */
	public speed_Scale110(String titre) {
		...
		btn_add100
				.setIcon(new ImageIcon(
						speed_Scale110.class
								.getResource("/com/jtattoo/plaf/acryl/icons/TreeClosedButton.gif")));
		btn_add100.setBounds(31, 10, 20, 20);
		...
		btn_sub010.setBounds(55, 80, 20, 20);
		...
		btn_sub100
				.setIcon(new ImageIcon(
						speed_Scale110.class
								.getResource("/com/jtattoo/plaf/acryl/icons/TreeOpenButton.gif")));
		btn_sub100.setBounds(31, 80, 20, 20);
